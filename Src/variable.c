...
// スラローム関連
t_slarom_parameter slarom300;  // 500 mm/sec のスラロームパラメータ
...
// sensor data 
t_sensor sen_front = {0,722,100,0,0,0}; // 前壁
t_sensor sen_fl={0,264,0,0,0,0};
t_sensor sen_fr={0,237,0,0,0,0};
t_sensor sen_l = {0,180,150,0,0,0}; // 横左壁0,105,150,0,0,0
t_sensor sen_r = {0,216,155,0,0,0}; // 横右壁0,176,157,0,0,0
